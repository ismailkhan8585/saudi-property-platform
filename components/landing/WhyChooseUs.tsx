      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {reasons.map(({ icon, title, desc }) => (
            <div
              key={title}
              className="group flex gap-4 bg-surface-secondary hover:bg-navy-50 border border-surface-border hover:border-navy-200 rounded-2xl p-6 transition-all duration-300"
            >
