    ...
    <section className="section-padding bg-white">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
          {testimonials.map((t) => (
            <div key={t.id} className="bg-surface-secondary border border-surface-border rounded-2xl p-6 flex flex-col">
              ...
              <p className="text-gray-600 text-sm leading-relaxed flex-1 mb-5">"{t.quote_text}"</p>
