      ...
      <main className="min-h-screen bg-surface-secondary">
        <div className="bg-navy-700 pt-20 pb-10">
          <div className="max-w-7xl mx-auto px-4">
            <h1 className="font-heading font-800 text-white text-3xl md:text-4xl">Properties for Rent in Lahore</h1>
            <p className="text-white/60 mt-2">Quality rental properties across all Lahore areas</p>
          </div>
        </div>
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="flex gap-8">
            ...
            <Suspense fallback={<div className="flex-1 animate-pulse bg-gray-200 rounded-2xl h-96" />}>
              <PropertyGrid initialPurpose="RENT" />
            </Suspense>
          </div>
        </div>
      </main>
