...
export const metadata: Metadata = {
  title: `All Properties in Lahore | ${AGENT_NAME_EN}`,
};
      ...
      <main className="min-h-screen bg-surface-secondary">
        <div className="bg-navy-700 pt-20 sm:pt-24 pb-8 sm:pb-10">
          <div className="max-w-7xl mx-auto px-4">
            <h1 className="font-heading font-800 text-white text-2xl sm:text-3xl md:text-4xl">All Properties in Lahore</h1>
            <p className="text-white/60 text-sm sm:text-base mt-2">Find your perfect property from our verified listings</p>
          </div>
        </div>
        <div className="max-w-7xl mx-auto px-4 py-5 sm:py-8">
          <div className="flex flex-col lg:flex-row gap-5 lg:gap-8">
            ...
            <Suspense fallback={<div className="flex-1 animate-pulse bg-gray-200 rounded-2xl h-96" />}>
              <PropertyResults searchParams={resolvedSearchParams} />
            </Suspense>
          </div>
        </div>
      </main>
